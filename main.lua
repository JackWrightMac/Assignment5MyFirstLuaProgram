...
-- Name: Jack Wright
-- Course: ICS2O/3C
-- This program makes two images spin and move then solves a math problem and plays sound.
...
--Creates background sound
local backgroundSound = audio.loadSound("Sounds/background005.mp3")
...
areaTextTriangle: setTextColor(255,0,0)
